...
Paul's detail page was the easiest to restyle as he kept to standard style practices and tried not to style --%>
    ...
    <div class="paul" style="text-align: center">
        <div style="text-align: center">
            <span style="color: #FF0000">
            <br />
            ** PLEASE STOP HERE THIS IS NOT PORKODIS UPDATE CUSTOMER FUNCTION THIS IS NOT IN USE FOR THE THREADED PROJECT **</span><br style="color: #FF0000" />
            <span style="color: #FF0000">** THIS WAS A BACKUP INCASE WE COULD NOT USE PORKODIS ON PRESENTATION DAY **</span><br />
        </div>
        <table class="table">
