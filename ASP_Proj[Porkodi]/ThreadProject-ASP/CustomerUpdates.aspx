...
<body>
    ...
    <div>
        ...
        <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" DataSourceID="ObjectDataSource1" DataTextField="CustFirstName" DataValueField="CustomerID">
        </asp:DropDownList>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" DataObjectTypeName="Customers" OldValuesParameterFormatString="original_{0}" SelectMethod="GetCustomer" TypeName="CustomersDB" UpdateMethod="UpdateCustomers">
            <SelectParameters>
